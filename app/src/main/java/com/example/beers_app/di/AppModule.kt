package com.example.beers_app.di

import android.content.Context
import androidx.room.Room
import com.example.beers_app.data.database.*
import com.example.beers_app.data.network.ApiClient
import com.example.beers_app.data.network.BeersApiService
import com.example.beers_app.data.repositories.CartRepositoryImpl
import com.example.beers_app.data.repositories.LikesRepositoryImpl
import com.example.beers_app.data.repositories.MenuItemsRepositoryImpl
import com.example.beers_app.data.repositories.UserRepositoryImpl
...
import com.example.beers_app.domain.use_cases.cart.*
import com.example.beers_app.domain.use_cases.likes.*
import com.example.beers_app.domain.use_cases.menu_items.*
import com.example.beers_app.domain.use_cases.users.*
import com.example.beers_app.domain.use_cases.menu_validation.*
import com.example.beers_app.domain.use_cases.user_validation.NameValidationUseCase
import com.example.beers_app.domain.use_cases.user_validation.PasswordValidationUseCase
import com.example.beers_app.domain.use_cases.user_validation.PhoneNumberValidationUseCase
import com.example.beers_app.domain.use_cases.user_validation.UserValidationUseCases
import com.example.beers_app.util.Constants.BASE_URL
import com.example.beers_app.util.Constants.DATABASE_NAME
import com.example.beers_app.util.Constants.HTTP_CLIENT_TIMEOUT_DURATION
import com.example.beers_app.util.mapper.MenuItemMapper
import com.example.beers_app.util.security.SecurityUtils
import com.example.beers_app.util.security.SecurityUtilsImpl
