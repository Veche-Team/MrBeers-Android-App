...
import com.example.beers.databinding.FragmentMenuItemListBinding
...
import com.example.beers_app.presentation.fragments.itemlist.epoxy.MenuItemListEpoxyController
        ...
        controller = MenuItemListEpoxyController(
            ...
            onNoUserClick = {
                if (!isToastShowing) {
                    Toast.makeText(
                        requireContext(),
                        getString(R.string.need_to_login_toast),
                        Toast.LENGTH_SHORT
                    )
                        .show()
                    isToastShowing = true
